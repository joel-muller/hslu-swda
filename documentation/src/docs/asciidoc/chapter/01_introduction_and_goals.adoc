...
2. Die Prüfung ob die Bestellung gültig ist geschieht im Backend asynchron. Eine Input Validierung im Frontend währe vorteilhaft, aber nicht zwingend nötig.
