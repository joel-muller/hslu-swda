...
//        List<OrderArticle> articles = List.of(new OrderArticle(1, 10), new OrderArticle(2, 20));
...
//        UUID orderId = UUID.randomUUID();
//        UUID storeId = UUID.randomUUID();
//        List<OrderArticle> initialArticles = List.of(new OrderArticle(1, 10));
//        List<OrderArticle> newArticles = List.of(new OrderArticle(2, 20), new OrderArticle(3, 30));
//
...
//        assertTrue(order.getArticleOrderedList().contains(new OrderArticle(1, 10)), "First article should match the first entry in the map.");
//        assertTrue(order.getArticleOrderedList().contains(new OrderArticle(2, 20)), "First article should match the first entry in the map.");
//    }
//
//    @Test
