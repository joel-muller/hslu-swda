...
class HandleStoreRequestArticlesTest {
    UUID storeId;
    ...
    void testStoreNotValid() {
        ...
        new HandleNewOrder().modify(databaseConnector, new StoreRequestArticles(newOrderId, UUID.randomUUID(), UUID.randomUUID(), new HashMap<>()), service);
    ...
    void testStoreValidNothingHasToGetReordered() {
        ...
        orderList.put(1, 3);
        orderList.put(2, 5);
        new HandleNewOrder().modify(databaseConnector, new StoreRequestArticles(newOrderId, UUID.randomUUID(), storeId, orderList), service);
        assertNull(service.lastWarehouseRequest);
    ...
    void testStoreValidEverythingHasToGetOrdered() {
        ...
        reorder.put(33, 3);
        reorder.put(44, 5);
        assertEquals(new WarehouseRequest(newOrderId, storeId, reorder), service.lastWarehouseRequest);
