...
public class GatewayReceiver<T extends IngoingMessage> implements MessageReceiver {
    ...
    public GatewayReceiver(final DatabaseConnector database, final String exchangeName, final BusConnector bus, final Modifiable modifiable, Class<T> messageGenericClass, Service service) {
