...
public final class CentralWarehouseService implements AutoCloseable {
    ...
    private void receiveCentralWarehouseOrders() throws IOException{
        ...
        bus.listenFor(exchangeName,"CentralWarehouseService <- "+ Routes.WAREHOUSE_REGISTER,Routes.WAREHOUSE_REGISTER,new CentralWarehouseOrderReceiver(exchangeName,bus, stock));
